...
<div class="flex h-screen overflow-hidden">
    ...
    <aside :class="sidebarOpen ? 'w-64' : 'w-[68px]'"
        ...
        <nav class="flex-1 px-2 py-4 overflow-y-auto space-y-0.5">
            ...
            <x-nav-item
                ...
                label="Plans"
                :active="request()->routeIs('superadmin.plans.*')"
    ...
    <aside x-show="mobileOpen" x-cloak
        ...
        <nav class="flex-1 px-2 py-4 space-y-0.5" x-data="{ sidebarOpen: true }">
            ...
            <x-nav-item href="{{ route('superadmin.plans.index') }}" label="Plans" :active="request()->routeIs('superadmin.plans.*')" icon="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"/>
        </nav>
    </aside>
