...
<section id="testimonials" class="py-28 bg-white">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-20 text-center">
            @foreach([['500+', 'Organizations'], ['80+', 'Themes available'], ['$10k+', 'Donations processed'], ['99.9%', 'Uptime SLA']] as $i => $stat)
            <div class="reveal" data-delay="{{ $i + 1 }}">
                <div class="text-4xl font-bold text-slate-900 mb-1 tabular-nums">{{ $stat[0] }}</div>
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="reveal group relative bg-slate-50 rounded-2xl p-8 border border-slate-100 hover:border-indigo-100 hover:shadow-xl hover:shadow-indigo-500/5 transition-all duration-300 hover:-translate-y-1"
                 data-delay="{{ $i + 1 }}">
