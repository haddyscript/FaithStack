        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
                ...
                <div class="reveal flex flex-wrap gap-4" data-delay="5">
                    <a href="/superadmin/login" data-magnetic
            ...
            <div class="hidden lg:flex justify-center items-center">
                <div class="mockup-float relative w-full max-w-lg">
                    ...
                    {{-- Floating chips --}}
                    <div class="absolute -left-10 top-[38%] bg-white rounded-2xl px-3.5 py-2.5 shadow-[0_20px_60px_rgba(0,0,0,0.3)] text-xs font-semibold text-slate-800 flex items-center gap-2 border border-slate-100/80">
                        <div class="w-5 h-5 rounded-full bg-emerald-500 flex items-center justify-center text-white text-[9px] font-bold">✓</div>
                        Theme applied!
                    </div>
                    <div class="absolute -right-9 bottom-[28%] bg-white rounded-2xl px-3.5 py-2.5 shadow-[0_20px_60px_rgba(0,0,0,0.3)] text-xs font-semibold text-slate-800 flex items-center gap-2 border border-slate-100/80">
                        <span>💰</span> $1,240 raised
                    </div>
                    <div class="absolute -right-7 top-[22%] bg-[#16161e] border border-white/[0.08] rounded-2xl px-3 py-2 shadow-xl text-[11px] text-white/60 flex items-center gap-2">
