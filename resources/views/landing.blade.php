...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { -webkit-font-smoothing: antialiased; box-sizing: border-box; }
        ...
        /* GSAP-driven sections need transform-origin centred top so
           the "zoom-in" scale reads as a camera move forward. */
        section > .max-w-7xl,
        section > .max-w-6xl {
            transform-origin: 50% 0%;
        }

        /* Glassmorphism on module cards (dark glass over ambient glow) */
        .module-card {
            -webkit-backdrop-filter: blur(10px);
            backdrop-filter: blur(10px);
        }

        /* Feature cards get a subtle glass depth on hover */
        .feature-card {
